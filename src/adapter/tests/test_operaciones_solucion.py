...
from adapter.entidades_solucion import Cuenta
from adapter.entidades_solucion import TarjetaCuenta
from adapter.entidades_solucion import TarjetaCredito
